  ...
  try {
    ...
    return NextResponse.json({
      ...
      current_reputation: {
        ...
        metrics: {
          bounce_rate: Math.round(reputationCheck.metrics.bounceRate * 10000) / 100, // Convert to percentage with 2 decimals
          complaint_rate: Math.round(reputationCheck.metrics.complaintRate * 100000) / 1000, // Convert to percentage with 3 decimals
