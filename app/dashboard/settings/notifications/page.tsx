        ...
        <CardContent className="space-y-4">
          ...
          <div className="pl-4 space-y-4 border-l-2 border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="import-completion"
                checked={settings.import_completion_email}
                onCheckedChange={(checked) => handleSettingChange('import_completion_email', checked)}
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="import-failure"
                checked={settings.import_failure_email}
                onCheckedChange={(checked) => handleSettingChange('import_failure_email', checked)}
                disabled={!settings.email_notifications}
              />
            </div>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              checked={settings.campaign_notifications}
              onCheckedChange={(checked) => handleSettingChange('campaign_notifications', checked)}
            />
          </div>
