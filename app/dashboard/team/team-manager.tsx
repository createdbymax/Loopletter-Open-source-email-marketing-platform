...
import { Users, Trash2, Mail, Lock, UserPlus, Shield, } from "lucide-react";
...
export function TeamManager({ artist }: TeamManagerProps) {
    ...
    return (<FeatureGate feature="multiUserAccess" artist={artist} fallback={<div className="space-y-6">
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  ...
                  <Input id="member-email" type="email" value={newMember.email} onChange={(e) => setNewMember({ ...newMember, email: e.target.value })} placeholder="colleague@example.com"/>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="member-name">Name (Optional)</Label>
                  <Input id="member-name" value={newMember.name} onChange={(e) => setNewMember({ ...newMember, name: e.target.value })} placeholder="John Doe"/>
                </div>
            ...
            role: value as "owner" | "admin" | "editor" | "viewer",
              ...
              <DialogFooter>
                ...
                <Button onClick={handleInviteMember} disabled={isInviting || !newMember.email}>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 h-2 bg-gray-200 rounded-full overflow-hidden">
              <div className="h-full bg-blue-600 rounded-full" style={{ width: `${(teamMembers.length / 5) * 100}%` }}></div>
            </div>
