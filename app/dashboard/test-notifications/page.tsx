      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button
              variant="outline"
              onClick={() => sendPresetNotification('import_success')}
              disabled={loading}
            ...
            <Button
              variant="outline"
              onClick={() => sendPresetNotification('import_failed')}
              disabled={loading}
              className="flex items-center gap-2 h-auto p-4"
            >
            ...
            <Button
              variant="outline"
              onClick={() => sendPresetNotification('campaign_sent')}
              disabled={loading}
              className="flex items-center gap-2 h-auto p-4"
            >
            ...
            <Button
              variant="outline"
              onClick={() => sendPresetNotification('system_alert')}
              disabled={loading}
              className="flex items-center gap-2 h-auto p-4"
            >
