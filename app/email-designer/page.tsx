...
export default function EmailDesignerPage() {
    ...
    return (<div className="h-screen flex flex-col bg-gray-50 dark:bg-neutral-900">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        }} onSendTest={handleSendTest} fanCount={0} subscriptionPlan="starter"/>
      </div>
    </div>);
}
