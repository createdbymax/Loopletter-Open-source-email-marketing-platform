...
export default async function SubscribePage({ params }: SubscribePageProps) {
    try {
        ...
        return (<div className="min-h-screen bg-gray-950 relative overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
          <div className="max-w-lg w-full">
            <div className="bg-gray-900/50 border-gray-800/50 backdrop-blur-xl shadow-2xl rounded-xl p-8 text-center">
              ...
              <a href="/" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl transition-all duration-300 shadow-lg shadow-blue-500/25">
                Go to Loopletter
              </a>
            </div>
          </div>
