      ...
      <div className="max-w-md w-full text-center">
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <div className="space-y-4">
            ...
            <Link
              href="/dashboard"
              className="block w-full text-gray-600 hover:text-gray-800 font-medium py-3 px-6 rounded-xl border border-gray-300 hover:border-gray-400 transition-colors"
            >
              Go to Dashboard
            </Link>
          </div>
