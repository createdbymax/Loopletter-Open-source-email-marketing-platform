    ...
    return (<div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-2xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          {saved && (<div className="mt-4 p-3 bg-green-100 text-green-800 rounded-lg inline-block">
        ...
        <div className="space-y-6">
          ...
          <Card>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <Label htmlFor="subscription" className="font-medium flex items-center gap-2">
                    {isSubscribed ? (<CheckCircle className="w-4 h-4 text-green-600"/>) : (<XCircle className="w-4 h-4 text-red-600"/>)}
            ...
            : `You won't receive any emails from ${fan.artist?.name || 'this artist'}`}
                ...
                <Switch id="subscription" checked={isSubscribed} onCheckedChange={setIsSubscribed}/>
              </div>

              {!isSubscribed && (<div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
