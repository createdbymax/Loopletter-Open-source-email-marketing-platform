...
export function MailyEditor({ onBack, onSave, onSend, initialHtml = '', templateData, templateId, fanCount = 0, subscriptionPlan = 'starter', subject = '', previewText = '', artist }: MailyEditorProps) {
    ...
    return (<div className="flex flex-col h-full bg-gray-50 dark:bg-neutral-900">
      ...
      <div className="flex-1 overflow-y-auto">
        <EmailEditorSandbox template={useMemo(() => {
        ...
        }, [initialHtml, templateData, templateId, subject, previewText])} onSave={handleSave} onUpdate={handleSend} onSendTest={handleSendTest} setEditor={handleSetEditor} autofocus="end" fanCount={fanCount} subscriptionPlan={subscriptionPlan} artist={artist}/>
      </div>
    </div>);
}
