...
import { Bold, Italic, Underline as UnderlineIcon, AlignLeft, AlignCenter, AlignRight, Link as LinkIcon, Image as ImageIcon, Heading1, Heading2, List, ListOrdered, Quote, Code, Undo, Redo } from 'lucide-react';
...
export function TiptapEmailDesigner({ initialContent = '<h1>Welcome to your email</h1><p>Start writing your content here...</p>', onChange, onSave, className = '', emailSubject }: TiptapEmailDesignerProps) {
    ...
    return (<div className={`border border-gray-200 rounded-md ${className}`}>
      {editor && (<div className="flex flex-wrap gap-1 p-2 border-b border-gray-200 bg-gray-50">
