...
import { CheckCircle, ArrowRight, X, Users, Mail, Settings, Globe, Sparkles, } from "lucide-react";
...
export function OnboardingProgress({ artist, fans, campaigns, onDismiss, onStartOnboarding, }: OnboardingProgressProps) {
    ...
    return (<Card className="border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-950/20">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {steps.map((step) => (<div key={step.id} className="flex flex-col items-center text-center space-y-2">
              <div className={`
              ...
              <div>
                ...
                {step.optional && (<Badge variant="outline" className="text-xs mt-1">
                    Optional
                  </Badge>)}
              </div>
            </div>))}
        ...
        {topRecommendation && (<div className="bg-white dark:bg-neutral-800 border dark:border-neutral-700 rounded-lg p-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          {onStartOnboarding && (<Button variant="outline" size="sm" onClick={onStartOnboarding} className="flex-1">
              Start Guided Setup
            </Button>)}
