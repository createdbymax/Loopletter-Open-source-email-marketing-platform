      ...
      case "profile":
        return (
          <ProfileStep
            artist={artist}
            onNext={handleNext}
            onStepComplete={() => handleStepComplete("profile")}
          />
        );
      case "audience":
        return (
          <AudienceStep
            artist={artist}
            onNext={handleNext}
            onStepComplete={() => handleStepComplete("audience")}
          />
        );
      case "domain":
        return (
          <DomainStep
            ...
            onStepComplete={() => handleStepComplete("domain")}
          />
        );
      case "campaign":
        return (
          <FirstCampaignStep
            artist={artist}
            onNext={handleNext}
            onStepComplete={() => handleStepComplete("campaign")}
          />
        );
      case "completion":
      ...
      <div className="w-80 bg-card border-r flex flex-col">
        ...
        <div className="p-6 border-b bg-card">
          <div className="flex items-center gap-3">
            ...
            {/* <div>
              <h1 className="text-lg font-semibold">Loopletter</h1>
              <p className="text-xs text-muted-foreground">Account Setup</p>
            </div> */}
          </div>
        </div>
            ...
            <div className="space-y-2">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  {/* Status Indicator */}
                  {index === currentStepIndex && (
                    <div className="w-1.5 h-1.5 bg-primary-foreground rounded-full animate-pulse ml-2"></div>
                  )}
                </div>
              ))}
            </div>
