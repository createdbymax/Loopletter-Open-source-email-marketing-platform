      ...
      <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={4}
                  className="bg-white/80 border-gray-200 focus:border-purple-300 focus:ring-purple-200 rounded-xl resize-none"
                />
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  <Input
                    ...
                    className="w-16 h-16 p-2 border-2 border-gray-200 rounded-xl cursor-pointer"
                  />
                ...
                <div className="flex-1">
                  <Input
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, primaryColor: e.target.value }))}
                    placeholder="#3B82F6"
                    className="h-12 bg-white/80 border-gray-200 focus:border-pink-300 focus:ring-pink-200 rounded-xl font-mono"
                  />
        ...
        <div className="flex justify-end pt-6">
          <Button 
            ...
            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:transform-none"
          >
            {loading ? (
              <>
