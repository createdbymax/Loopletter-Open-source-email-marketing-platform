            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleInputChange('cookie_consent_required', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={settings.analytics_opt_out_available}
                  onCheckedChange={(checked) => handleInputChange('analytics_opt_out_available', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={settings.data_processing_transparency}
                  onCheckedChange={(checked) => handleInputChange('data_processing_transparency', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={settings.automatic_deletion_enabled}
                  onCheckedChange={(checked) => handleInputChange('automatic_deletion_enabled', checked)}
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('privacy_policy_version', e.target.value)}
                  placeholder="1.0"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="email"
                  value={settings.dpo_contact_email}
                  onChange={(e) => handleInputChange('dpo_contact_email', e.target.value)}
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="gdpr_representative_contact"
                  value={settings.gdpr_representative_contact}
                  onChange={(e) => handleInputChange('gdpr_representative_contact', e.target.value)}
                  placeholder="Contact information for your GDPR representative (if applicable)"
                  rows={3}
                />
                <p className="text-sm text-muted-foreground">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="ccpa_contact_info"
                  value={settings.ccpa_contact_info}
                  onChange={(e) => handleInputChange('ccpa_contact_info', e.target.value)}
                  placeholder="Contact information for CCPA-related requests"
                  rows={3}
                />
                <p className="text-sm text-muted-foreground">
