...
export function QuarantineStatusCard() {
    ...
    const getStatusMessage = () => {
        if (stats.pending === 0)
            return 'All contacts approved';
        if (stats.pending === 1)
            return '1 contact needs review';
    ...
    return (<Card>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          {hasPendingReviews && (<Link href="/dashboard/admin/reviews" className="block">
          ...
          <div className="text-xs text-muted-foreground space-y-1">
            ...
            {stats.total > 0 && (<div className="flex items-center justify-between">
