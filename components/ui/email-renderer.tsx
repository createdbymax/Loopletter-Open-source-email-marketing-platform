        ...
        elements.push(
          <Section key={currentIndex++} style={{ margin: "16px 0" }}>
            {listItems.map((item, idx) => (
              ...
              >
                <span
                  style={{ position: "absolute", left: "0", color: "#6b7280" }}
                >
                  •
                </span>
                {item}
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (line.startsWith("### ")) {
        ...
        elements.push(
          <h1
            key={currentIndex++}
            className="text-3xl font-bold mt-8 mb-5 text-gray-900"
          >
            {line.substring(2)}
          </h1>
        );
      ...
      // Quotes
        ...
        elements.push(
          <blockquote
            key={currentIndex++}
            className="border-l-4 border-gray-300 pl-4 py-4 my-6 bg-gray-50 italic text-gray-600"
          >
            {quoteLines.map((quoteLine, idx) => (
