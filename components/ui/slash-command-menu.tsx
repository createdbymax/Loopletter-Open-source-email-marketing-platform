  ...
  return (
    ...
    >
      {commands.map((command, index) => (
        <button
          key={command.id}
          className={`flex items-center gap-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus-visible:bg-gray-100 focus-visible:text-gray-900 rounded-xl px-2 text-sm focus-visible:outline-none mx-1 min-h-8 ${
