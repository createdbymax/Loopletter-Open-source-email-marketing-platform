                    ...
                    <div className="min-h-[250px] sm:min-h-[300px]">
                        ...
                        >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            {formData.role === 'other' && (
                              <input
                                ...
                                className="w-full px-3 sm:px-4 py-2 sm:py-3 mt-2 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                              />
                            )}
                          </div>
                        </motion.div>
                      ...
                      {currentStep === 2 && (
                        ...
                        >
                          ...
                          <div>
                            ...
                            {formData.musicLinks.map((link, index) => (
                              <div key={index} className="flex gap-2 mb-2">
                                <input
                                  ...
                                  className="flex-1 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                                />
                                {formData.musicLinks.length > 1 && (
                                  <button
                                    type="button"
                                    onClick={() => removeMusicLink(index)}
                                    className="px-3 py-3 text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 rounded-lg transition-all"
                                  >
                                    <X className="w-4 h-4" />
                                  </button>
                                )}
                          ...
                          <div>
                            ...
                            <select
                              value={formData.fanBaseSize}
                              onChange={(e) => updateFormData({ fanBaseSize: e.target.value as any })}
                              className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                            >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              placeholder="e.g. Pop, Hip-Hop, Electronic, Indie Rock..."
                              className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                            />
                          </div>
                        </motion.div>
                      ...
                      {currentStep === 3 && (
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 gap-2">
                              {[
                                ...
                                <button
                                  ...
                                  className={`p-2 sm:p-3 text-xs sm:text-sm text-left rounded-lg border transition-all ${
                                    formData.currentReachMethods.includes(method)
                                      ? 'bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300'
                                      : 'bg-neutral-50 dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700'
                                  }`}
                                >
                          ...
                          {formData.currentReachMethods.includes('Email marketing') && (
                            <div>
                              <label className="block text-xs sm:text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
                              ...
                              <input
                                type="text"
                                value={formData.currentEmailPlatform || ''}
                                onChange={(e) => updateFormData({ currentEmailPlatform: e.target.value })}
                        ...
                        >
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => updateFormData({ emailFrequency: e.target.value as any })}
                              className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                            >
                          ...
                          <div className="flex items-center gap-3">
                            <input
                              type="checkbox"
                              id="betaFeedback"
                              checked={formData.openToBetaFeedback}
                              onChange={(e) => updateFormData({ openToBetaFeedback: e.target.checked })}
                              className="w-4 h-4 text-blue-600 bg-neutral-50 dark:bg-neutral-800 border-neutral-300 dark:border-neutral-600 rounded focus:ring-blue-500"
                            />
                          ...
                          <div>
                            ...
                            <textarea
                              value={formData.whyLoopletter || ''}
                              onChange={(e) => updateFormData({ whyLoopletter: e.target.value })}
                              placeholder="Tell us what drew you to Loopletter..."
                              rows={3}
                              className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none"
                            />
                          </div>
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              placeholder="Any additional context, questions, or comments..."
                              rows={3}
                              className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none"
                            />
                          </div>
                    ...
                    <div className="flex gap-2 sm:gap-3 mt-4 sm:mt-6">
                      {currentStep > 1 && (
                        <button
                          ...
                          className="flex-1 bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-semibold transition-all hover:bg-neutral-200 dark:hover:bg-neutral-700 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          Previous
                        </button>
                      )}
                      ...
                      {currentStep < totalSteps ? (
                        <button
                          ...
                          className="flex-1 bg-black hover:bg-neutral-800 dark:bg-blue-600 dark:hover:bg-blue-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-semibold transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed group"
                        >
                          Next
