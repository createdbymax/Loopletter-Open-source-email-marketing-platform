...
export function generateEmailHtml({ title, previewText, content, subscriptionPlan = 'starter' }: {
    title: string;
    previewText?: string;
    content: string;
...
export function generateBasicEmailHtml({ title, previewText, content, subscriptionPlan = 'starter' }: {
    title: string;
    previewText?: string;
    content: string;
    subscriptionPlan?: SubscriptionPlan;
